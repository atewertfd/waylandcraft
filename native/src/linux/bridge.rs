...
use crate::linux::egl::{EGLDisplay, EGLHelper};
use crate::linux::utils::get_time;
use crate::linux::xdg_spec::RawDesktopEntry;
use crate::linux::{WaylandCraft, wlc_init};
...
fn render_svg<'local>(
    ...
    Ok(crate::linux::svg::render_svg(path, width, height, data).is_some())
}
