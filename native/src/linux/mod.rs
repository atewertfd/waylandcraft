use crate::linux::bridge::BridgeState;
use crate::linux::ddm::WLCDataState;
use crate::linux::egl::EGLHelper;
use crate::linux::output::WLCOutput;
use crate::linux::satellite::SatelliteState;
use crate::linux::seat::WLCSeatState;
use crate::linux::xdg_spec::XDGSpecHelper;
use smithay::{
